                            ...
                            <div class="col-md-6 col-lg-4 col-xl-4">
                                <div class="rounded position-relative fruite-item">
                                    <div class="fruite-img">
                                        <img src="/images/product/${pr.image}" class="img-fluid w-100 rounded-top" alt="">
                                    </div>
                        ...
                        <nav aria-label="...">
                            <ul class="pagination d-flex justify-content-center mt-5">
                                <li class="page-item ${currentPage eq 1 ? 'disabled' : ''}">
                                    <a class="page-link rounded" href="/shop?page=${currentPage - 1}">&laquo;</a>
                                </li>
                                <c:forEach begin="0" end="${totalPages-1}" varStatus="loop">
                                    <li>
                                        <a class="${(loop.index + 1) eq currentPage ? 'active' : ''} page-link rounded" href="/shop?page=${loop.index+1}">${loop.index+1}</a>
                                    </li>
                                </c:forEach>
                                <li class="page-item ${currentPage eq (totalPages) ? 'disabled' : ''}">
                                    <a class="page-link rounded" href="/shop?page=${currentPage + 1}">&raquo;</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
