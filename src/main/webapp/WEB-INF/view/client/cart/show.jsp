                        ...
                        <tr>
                            <th scope="row">
                                <div class="d-flex align-items-center">
                                    <img src="images/product/1729080999419-lenovoV14G4.jpg" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="" alt="">
                                </div>
                            </th>
                            <td>
                                <p class="mb-0 mt-4">Lenovo V14 G4</p>
                            </td>
                            <td>
